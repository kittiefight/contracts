...
contract GameCreation is Proxied, Guard {
    ...
    */
        ...
        onlyKittyOwner(playerBlack, kittyBlack)
    {
        ...
        //*FIXED* not one player kittieHell
        ...
        onlyContract(CONTRACT_NAME_GAMEMANAGER)
    {
        ...
        //return Kitties to owner if acquired from kittieHell
    ...
    onlyContract(CONTRACT_NAME_GM_SETTER_DB)
    {
        ...
        if(state == 1){
            ...
            uint scheduledJob = cronJob.addCronJob(CONTRACT_NAME_GAMECREATION, startTime, abi.encodeWithSignature("callForfeiterCron(uint)", gameId));
    ...
    function callForfeiterCron(uint gameId)
        ...
        onlyContract(CONTRACT_NAME_CRONJOB)
    {
        string memory reason = "Did not hit start";
