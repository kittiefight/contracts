...
contract Staking is Autopetrified, ERC900, IStakingLocking, IsContract, Owned {
     ...
     */
    function initialize(ERC20 _stakingToken) external onlyOwner {
    ...
    function _callLockManagerCallback(uint256 _amount, address _lockManager, uint256 _allowance, bytes memory _data) internal {
