...
const gene3 = '290372710203698797209297887795752417072070342201768110150904359522134138'
...
contract('RarityCalculator', (accounts) => {
    ...
    it('is able to convert the genome of a kitty to binary', async () => {
        ...
        const kittie1BodyGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 0)
        const kittie1PatternGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 1)
        const kittie1ColoreyesGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 2)
        const kittie1EyesGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 3)
        const kittie1Color1GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 4)
        const kittie1Color2GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 5)
        const kittie1Color3GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 6)
        const kittie1WildGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 7)
        const kittie1MouthGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 8)
        const kittie1EnvironmentGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie1, 9)
        ...
        const kittie3BodyGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 0)
        const kittie3PatternGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 1)
        const kittie3ColoreyesGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 2)
        const kittie3EyesGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 3)
        const kittie3Color1GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 4)
        const kittie3Color2GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 5)
        const kittie3Color3GeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 6)
        const kittie3WildGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 7)
        const kittie3MouthGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 8)
        const kittie3EnvironmentGeneBinary = await RarityCalculatorInst.kittiesDominantGeneBinary.call(kittie3, 9)
    ...
    it('is able to convert the genome in binary to kai value', async () => {
        ...
        const kittie1BodyGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 0)
        const kittie1PatternGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 1)
        const kittie1ColoreyesGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 2)
        const kittie1EyesGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 3)
        const kittie1Color1GeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 4)
        const kittie1Color2GeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 5)
        const kittie1Color3GeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 6)
        const kittie1WildGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 7)
        const kittie1MouthGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 8)
        const kittie1EnvironmentGeneKai = await RarityCalculatorInst.kittiesDominantGeneKai.call(kittie1, 9)
    ...
    it('is able to convert the genome in kai to cattributes', async () => {
        ...
        const kittie1BodyCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 0)
        const kittie1PatternCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 1)
        const kittie1ColoreyesCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 2)
        const kittie1EyesCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 3)
        const kittie1Color1Cattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 4)
        const kittie1Color2Cattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 5)
        const kittie1Color3Cattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 6)
        const kittie1WildCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 7)
        const kittie1MouthCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 8)
        const kittie1EnvironmentCattribute = await RarityCalculatorInst.kittiesDominantCattributes.call(kittie1, 9)
