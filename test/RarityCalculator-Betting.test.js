...
contract('Betting', accounts => {
  ...
  it('calculates and returns attack type, attackHash, current defense level of the given corner, as well as the current opponent defense level due to each bet placed by the given corner in a game', async () => {
