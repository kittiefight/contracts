...
contract("GameManager", (accounts) => {
  ...
  it("sets Epoch 0, Pool 0, and sets investment for Epoch 0", async () => {
    ...
    console.log("Investments in Pool:", amounts.investment.toString());
    console.log("********************************************************\n");
  });
...
/*
  ...
  it("Starts the second game in the same epoch", async () => {
    console.log(
      "\n$$$$$$$$$$$$$$$$$$$$$$$$$$$$ GAME 2 $$$$$$$$$$$$$$$$$$$$$$$$$$$$"
    );
    let users = 40;
  ...
  it("an investor can burn his Ethie Token NFT and receive ethers locked and interest accumulated", async () => {
    ...
    await earningsTracker.burnNFT(ethie_token_ID_2, { from: accounts[2] })
      .should.be.fulfilled;
