...
const GAME_PRESTART = 20 // 1 min
const GAME_DURATION = 240 // 2 min
const ETH_PER_GAME = new BigNumber(web3.utils.toWei("1", "ether")); //$50,000 / (@ $236.55 USD/ETH)
const TOKENS_PER_GAME = new BigNumber(web3.utils.toWei("1000", "ether")); // 1,000 KTY
const GAME_TIMES = 100 //Scheduled games 10 min apart
...
const PERFORMANCE_TIME_CHECK = 5;
